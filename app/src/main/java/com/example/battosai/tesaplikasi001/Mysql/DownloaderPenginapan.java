...
public class DownloaderPenginapan  extends AsyncTask<Void, Void, String> { //Tambah di class extends AsyncTask <Void, Void, String>
    ...
    public DownloaderPenginapan (Context context, String urlAnddress, ListView listView) {
...
//tambahan  return this.DownloadData();
    ...
    protected void onPostExecute(String JsonData) { //s ganti JsonData
        ...
        if (JsonData==null){
            ...
            new data_parsePenginapan(context,JsonData,listView).execute();
